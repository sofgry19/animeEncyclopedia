...
CurrentSeason currentSeasonFromJson(String str) =>
    CurrentSeason.fromJson(json.decode(str));
...
class CurrentSeason {
  ...
  factory CurrentSeason.fromJson(Map<String, dynamic> json) =>
      new CurrentSeason(
        ...
        anime:
            new List<Anime>.from(json["anime"].map((x) => Anime.fromJson(x))),
      );
...
final genreTypeValues = new EnumValues({"anime": GenreType.ANIME});
